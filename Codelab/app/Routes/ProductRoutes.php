...
class ProductRoutes
{
    public function handle($method, $path)
    {
        ...
        // JIKA REQUEST METHOD GET DAN PATH DIAWALI DENGAN '/api/product/'
        ...
        // JIKA REQUEST METHOD PUT DAN PATH DIAWALI DENGAN '/api/product/'
        ...
        // JIKA REQUEST METHOD DELETE DAN PATH DIAWALI DENGAN '/api/product/'
